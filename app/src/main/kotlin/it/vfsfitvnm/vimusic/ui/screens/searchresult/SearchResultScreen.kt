...
fun SearchResultScreen(query: String, onSearchAgain: () -> Unit) {
    ...
    RouteHandler(listenToGlobalEmitter = true) {
        ...
        host {
            ...
            val emptyItemsText = "No se han encontrado resultados. Intente con otra consulta o categoría"
            ...
            Scaffold(
                ...
                tabColumnContent = { Item ->
                    Item(0, "Canciones", R.drawable.musical_notes)
                    Item(1, "Albums", R.drawable.disc)
                    Item(2, "Artistas", R.drawable.person)
                    Item(3, "Videos", R.drawable.film)
                    Item(4, "Playlists", R.drawable.playlist)
                    Item(5, "Destacados", R.drawable.playlist)
                }
            ) { tabIndex ->
