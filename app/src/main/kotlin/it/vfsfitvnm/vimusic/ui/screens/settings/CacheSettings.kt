...
fun CacheSettings() {
    ...
    Column(
        ...
        SettingsDescription(text = "Cuando la memoria caché se queda sin espacio, los recursos a los que no se ha accedido durante más tiempo se borraran.")
        ...
        Coil.imageLoader(context).diskCache?.let { diskCache ->
            ...
            SettingsEntryGroupText(title = "CACHE DE IMAGEN")
        ...
        binder?.cache?.let { cache ->
            ...
            SettingsEntryGroupText(title = "CACHE DE CANCIONES")
