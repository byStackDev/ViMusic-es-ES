        ...
        host {
            Scaffold(
                ...
                tabColumnContent = { Item ->
                    Item(0, "Apariencia", R.drawable.color_palette)
                    Item(1, "Reproductor", R.drawable.play)
                    Item(2, "Cache", R.drawable.server)
                    Item(3, "Base de datos", R.drawable.server)
                    Item(4, "Otros", R.drawable.shapes)
                    Item(5, "Acerca de", R.drawable.information)
                }
            ) { currentTabIndex ->
