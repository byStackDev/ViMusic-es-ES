...
fun colorPaletteOf(
    ...
    return when (colorPaletteName) {
        ColorPaletteName.Defecto, ColorPaletteName.Dinámico -> when (colorPaletteMode) {
            ColorPaletteMode.Claro -> DefaultLightColorPalette
            ColorPaletteMode.Oscuro -> DefaultDarkColorPalette
            ColorPaletteMode.Sistema -> when (isSystemInDarkMode) {
                true -> DefaultDarkColorPalette
                false -> DefaultLightColorPalette
            }
        }
        ColorPaletteName.NegroPuro -> PureBlackColorPalette
    }
}
...
fun dynamicColorPaletteOf(hsl: FloatArray, isDark: Boolean): ColorPalette {
    return colorPaletteOf(ColorPaletteName.Dinámico, if (isDark) ColorPaletteMode.Oscuro else ColorPaletteMode.Claro, false).copy(
