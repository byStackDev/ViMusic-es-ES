        ...
        host {
            ...
            val headerContent: @Composable (textButton: (@Composable () -> Unit)?) -> Unit =
                { textButton ->
                    if (artist?.timestamp == null) {
                        ...
                        Header(title = artist?.name ?: "Desconocido") {
                            textButton?.invoke()
            ...
            Scaffold(
                ...
                tabColumnContent = { Item ->
                    Item(0, "Descripción", R.drawable.sparkles)
                    Item(1, "Canciones", R.drawable.musical_notes)
                    Item(2, "Albums", R.drawable.disc)
                    Item(3, "Sencillo", R.drawable.disc)
                    Item(4, "Biblioteca", R.drawable.library)
                },
            ) { currentTabIndex ->
                    ...
                    when (currentTabIndex) {
                        ...
                        2 -> {
                            ...
                            ItemsPage(
                                ...
                                headerContent = headerContent,
                                emptyItemsText = "Este artista no lanzó ningún álbum.",
                                itemsPageProvider = artistPage?.let {
                                    ({ continuation ->
                                        continuation?.let {
                                            Innertube.itemsPage(
                        ...
                        3 -> {
                            ...
                            ItemsPage(
                                ...
                                headerContent = headerContent,
                                emptyItemsText = "Este artista no lanzó ningún sencillo.",
                                itemsPageProvider = artistPage?.let {
                                    ({ continuation ->
                                        continuation?.let {
                                            Innertube.itemsPage(
